...
//        }
    ...
    protected void onAutosave() {
        try {
            mBlocklyActivityHelper.saveWorkspaceToAppDir("autosave_workspace.xml");//getWorkspaceAutosavePath());
...
//            mBlocklyActivityHelper.loadWorkspaceFromAppDir(filePath);
            ...
            mBlocklyActivityHelper.loadWorkspaceFromAppDir(in);
...
//        mActionBar.setDisplayShowTitleEnabled(true);
        ...
        if (content != null) {
            ...
            ImageButton blockly_run_button = content.findViewById(R.id.blockly_run_button);
            blockly_run_button.setOnClickListener(new View.OnClickListener() {
                @Override
