...
import static com.google.blockly.android.Constants.bg_ids;
...
public class CategoryTabs extends RecyclerView {
    ...
    public CategoryTabs(Context context, AttributeSet attrs, int style) {
        ...
        ItemSpacingDecoration divider = new ItemSpacingDecoration(mAdapter);
...
//            holder.mRotator.setChildRotation(mLabelRotation);
            ...
            holder.mLabel.setBackgroundResource(bg_ids[tabPosition%3]);
...
//                        Block block = ((BlocklyCategory.BlockItem) (category.getItems().get(i))).getBlock();
//                        block.setColor(CategoryTabs.this.getResources().getColor(color_ids[index%3]));
//
//                    }
...
//            mRotator = (RotatedViewGroup) itemView;
            mRotator = view;
            mLabel = view.findViewById(R.id.tv_toolbox);
